...
#    Updated: 2018/01/31 17:08:00 by bpajot      ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
FILES = ft_printf.c ft_printf_type.c ft_printf_a.c ft_printf_c.c ft_printf_d.c \
		...
		ft_printf_x.c ft_putwchar.c ft_putstr_size.c ft_putchar_int.c \
		ft_putwstr.c ft_putnbr_size.c ft_putnbr_base.c parse.c parse2.c parse3.c
